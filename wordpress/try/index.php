...
<<footer id="footer">
				...
				<div class="inner">
					<div class="content">
						<h3>About Tittle-Tattle</h3>
						<p>This project aims at fighting one of the most grave social ills namely 'Fake news'. A lot of misleading messages are received by many via various social media channels. This is a simple tool where you can post whatever you receive and use the genuinity meter to get results. Let's make India a better place to live in.</p>
					</div>
